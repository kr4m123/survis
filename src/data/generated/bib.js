const generatedBibEntries = {
    "abeyagunasekera_lisa_2022": {
        ...
        "keywords": "Application:COVID-19, XAI Used:LISA, XAI Used:LIME, XAI Used:Integrated gradients, XAI Used:Anchors, XAI Used:SHAP, Type/Focus:Multiple XAI, AI Used:Inception v2, Data Used:X-Ray, Data Used:Photos, Additives, Anchors, Chest X-ray, CNN, CXR, Debugging, Explainable Artificial Intelligence, Integrated Gradients, LIME, LISA, Local Interpritable Model Agnostic Explanations, Medical diagnosis, Mission critical systems, Neural networks, Predictive models, SHAP, Shapley Additive Explanations, Transfer learning, Unified Explanations, XAI",
        "month": "apr,",
        "pages": "1--9",
        "publisher": "IEEE",
    ...
    "barua_explainable_2023": {
        ...
        "keywords": "Application:Bone fractures, XAI Used:Saliency map, Type/Focus:Multiple XAI, AI Used:VGG-16, AI Used:VGG-19, AI Used:DenseNet121, AI Used:DenseNet169, Data Used:X-Ray, Data Used:Photos, Bones, Convolutional neural network, Convolutional neural networks, Explainable AI (XAI), Humerus, Predictive models, Shoulder, Training, Visualization, X-ray diagnosis, X-ray imaging",
        "month": "dec,",
        "pages": "1--6",
        "publisher": "IEEE",
    ...
    "born_accelerating_2021": {
        ...
        "keywords": "Application:COVID-19, XAI Used:CAM, Type/Focus:Single XAI, AI Used:VGG-16, Data Used:Ultrasound, Data Used:Photos, Data Used:Videos, machine learning, COVID-19, deep learning, medical imaging, Convolutional neural network, computer vision, interpretability, Lung imaging, pneumonia, supervised learning, ultrasound",
        "language": "en",
        "month": "jan,",
    ...
    "hicks_visual_2024": {
        ...
        "issn": "1932-6203",
        "journal": "PLOS ONE",
        "keywords": "Applications:Polyps, XAI Used:GRAD-CAM, XAI Used:Captum, Type/Focus:Comparison of XAI, AI Used:ResNet, Data Used:Photos, Deep learning, Artificial intelligence, Physicians, Surveys, Genitourinary imaging, Imaging techniques, Medical personnel, Psychological attitudes",
        "language": "en",
        "month": "may,",
    ...
    "hossain_explainable_2025": {
        ...
        "keywords": "Type/Focus:Literature Survey/Review",
        "month": "feb,",
        "number": "6",
        "pages": "148:1--148:46",
    ...
    "hossain_vision_2024": {
        ...
        "keywords": "Type/Focus:Single XAI, AI Used:VGG-16, AI Used:Inception v3, AI Used:Xception, Data Used:MRI, Data Used:Photos, XAI Used:LIME, Application:Brain tumors, explainable AI, Feature extraction, deep learning, Brain modeling, Brain tumor classification, Cancer, CCT, Computational modeling, EANet, ensemble learning, InceptionResNetV2, InceptionV3, LIME, Magnetic resonance imaging, multiclass classification, Residual neural networks, ResNet50, SWIN, transfer learning, Tumors, VGG16, VGG19, vision transformers, xception",
        "month": "mar,",
        "number": "3",
        "pages": "1261--1272",
    ...
    "hu_x-mir_2022": {
        ...
        "keywords": "Application:Skin cancer, Application:COVID-19, XAI Used:Saliency map, XAI Used:Occlusion-based saliency, XAI Used:Attention-based saliency, Type/Focus:Comparison of XAI, AI Used:DenseNet121, Data Used:X-Ray, Data Used:Photos, Accountability, Computer vision, COVID-19, Explainable AI, Fairness, Image retrieval, Machine learning, Measurement, Medical services, Privacy and Ethics in Vision Medical Imaging/Imaging for Bioinformatics/Biological and Cell Microscopy, Skin",
        "month": "jan,",
        "note": "ISSN: 2642-9381",
        "pages": "1544--1554",
        "publisher": "IEEE",
    ...
    "kerz_toward_2023": {
        ...
        "keywords": "Application:Mental health diagnoses, XAI Used:LIME, XAI Used:AGRAD, Type/Focus:Multiple XAI, AI Used:BiLSTM, AI Used:MentalRoBERTa, AI Used:Multi task-fusion models, Data Used:Textual, Data Used:Social media posts, artificial intelligence, Automated Mental Health Detection, deep learning - artificial intelligence, Explainable AI (XAI), machine learning, Natural Language Processing",
        "language": "English",
        "month": "dec,",
    ...
    "lucieri_exaid_2022": {
        ...
        "keywords": "Application:Skin cancer, XAI Used:ExAID, XAI Used:Textual, XAI Used:CLM, XAI Used:TCAV, Type/Focus:Multiple XAI, AI Used:SEResNeXt, Data Used:Textual, Data Used:Photos, Interpretability, Artificial intelligence in dermatology, Computer-aided diagnosis, Explainable artificial intelligence, Medical image processing, Textual explanations",
        "month": "mar,",
        "pages": "106620",
        "shorttitle": "{ExAID}",
    ...
    "murugan_efficient_2025": {
        ...
        "keywords": "Application:Breast cancer, XAI Used:LIME, XAI Used:SHAP, XAI Used:Saliency map, Type/Focus:Comparison of XAI, AI Used:ResNet, AI Used:VGG-16, AI Used:VGG-19, Data Used:Histological, Artificial Intelligence, Explainable artificial intelligence, Breast cancer, Convolutional neural networks (CNN)",
        "language": "en",
        "month": "feb,",
        "number": "5",
        "pages": "3759--3776",
